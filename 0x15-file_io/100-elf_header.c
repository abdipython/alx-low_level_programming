 ...
 * @e_ident: points to The array containing ELF magic numbers.
 *
 ...
 *
 * Description: Magic numbers are separated by indents.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: Its the pointer to an array containing the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 *   * @e_ident: It  points to an array containing the ELF version.
 *    */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident:It is the pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_type: An  ELF type.
 * @e_ident: It points to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @elf: Its the file descriptor of ELF file.
 *
 * Description: When the file cant be closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - It displays information contained in the
 *          ELF header at the start of an ELF file.
 * @argc: It is the No  of arguments supplied to the program.
 * @argv: Its the array of pointers to the arguments.
 *
