 ...
 * @fd: It is the file descriptor being closed.
 */
void close_file(int fd)
{
	int c;
...
/**
 * main - This copies the contents of the file to another file.
 ...
 * when file_from does not exist or cant be read - exit code 98.
 * when the file_to cannot be created or written to - exit code 99.
 * when  the file_to or file_from cannot be closed - exit code 100.
 */
